...
graduates.forEach(function(currentObj, university) {
  const schools = `${currentObj.university}`;
...
graduates.forEach(function(currentObj, first_name, email){
  const info = `${currentObj.first_name} ${currentObj.email}`;
...
zooAnimals.forEach(function(currentObj, animal_name, scientific_name) {
  let display = `Name: ${currentObj.animal_name}, Scientific: ${currentObj.scientific_name}.`;
  animalNames.push(display);
});
